...
load("JAGS_data/JAGS_hier_ORL_recovery_no_theta_young_adjusted_86.RData")
...
load("JAGS_data/JAGS_hier_ORL_recovery_no_theta_young_adjusted_3556.RData")
samples$BUGSoutput$summary
...
load("JAGS_data/JAGS_hier_ORL_recovery_no_theta_young_adjusted_4495.RData")
samples$BUGSoutput$summary
...
load("JAGS_data/JAGS_hier_ORL_recovery_no_theta_young_adjusted_5636.RData")
samples$BUGSoutput$summary
...
load("JAGS_data/JAGS_hier_ORL_recovery_no_theta_young_adjusted_6009.RData")
samples$BUGSoutput$summary
...
load("JAGS_data/JAGS_hier_ORL_recovery_no_theta_young_adjusted_6672.RData")
samples$BUGSoutput$summary
...
load("JAGS_data/JAGS_hier_ORL_recovery_no_theta_young_adjusted_7999.RData")
samples$BUGSoutput$summary
...
load("JAGS_data/JAGS_hier_ORL_recovery_no_theta_young_adjusted_8007.RData")
samples$BUGSoutput$summary
...
load("JAGS_data/JAGS_hier_ORL_recovery_no_theta_young_adjusted_9560.RData")
samples$BUGSoutput$summary
...
load("JAGS_data/JAGS_hier_ORL_recovery_no_theta_young_adjusted_9848.RData")
samples$BUGSoutput$summary
...
ggsave("plots_recovery/pl_young_recovery_mu_adjusted.png", pl_young_1)
...
ggsave("plots_recovery/pl_young_recovery_lambda_adjusted.png", pl_young_2)