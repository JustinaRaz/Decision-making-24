...
load("../JAGS_data/JAGS_hier_ORL_recovery_no_theta_young_887.RData")
...
ggsave("traceplots_young_mu.png", plot_1, width = 10, height = 20)

plot_2 <- ggarrange(pl6, pl7, pl8, pl9, pl10, ncol = 1, nrow = 5)

ggsave("traceplots_young_lambda.png", plot_2, width = 10, height = 20)
